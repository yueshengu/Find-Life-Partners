...
ggplot(data=unempl3, aes(x=factor(Age), y=UnemplRatio, group=Sex, colour=Sex)) +
    geom_line() + geom_point() + scale_y_continuous(limits = c(0, 0.15)) theme_classic()+theme(axis.text.x=element_text(angle=90,hjust=1))+xlab("Age")+ylab("Unemployment ratio")
```
...
<p align="center"><img src="figs/sugarDaddyPerc.png" ></p>
...
<p align="center"><img src="figs/sugarDaddyNum.png" ></p>
...
<p align="center"><img src="figs/perfectGirlPerc.png" ></p>
...
<p align="center"><img src="figs/perfectGirlNum.png" ></p>
